...
import PrahariLanding from './pages/DPRLandingPage'
...
import EvaluationBoardPage from './pages/EvaluationBoard'
import ReviewQueuePage from './pages/ReviewQueue'
import BidderManagementPage from './pages/BidderManagement'
...
function AppRoutes() {
  ...
  return (
    <Routes>
      ...
      <Route path="/" element={<PrahariLanding />} />
      ...
      <Route path="/user/self-check" element={<SelfCheckPage />} />
      ...
      <Route path="/admin/evaluations/:id" element={<ProtectedRoute><EvaluationBoardPage /></ProtectedRoute>} />
      <Route path="/admin/evaluations/:id/review" element={<ProtectedRoute><ReviewQueuePage /></ProtectedRoute>} />
      <Route path="/admin/evaluations/:id/bidders" element={<ProtectedRoute><BidderManagementPage /></ProtectedRoute>} />
